...
**[morse-code]** is a program that allows the user to input morse code and convert the message into English words.
...
```sh
  cd my-folder
  git clone git@github.com:ivanmvh/morse-code.git
```

### Usage
In the vcommand line
